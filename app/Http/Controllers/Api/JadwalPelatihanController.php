...
class JadwalPelatihanController extends Controller
{
    ...
    {
        $q = JadwalPelatihan::withCount('peserta');
        ...
        return response()->json(['success' => true, 'data' => $q->orderBy('tanggal')->get()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Jadwal dibuat.', 'data' => JadwalPelatihan::create($v)], 201);
    }

    public function show(string $id)
    {
        return response()->json(['success' => true, 'data' => JadwalPelatihan::with('peserta')->findOrFail($id)]);
    }

    public function update(Request $request, string $id)
    {
        $j = JadwalPelatihan::findOrFail($id);
        $j->update($request->only(['judul', 'jenis_pelatihan', 'tanggal', 'jam', 'ruangan', 'jenis_sesi', 'status']));
        return response()->json(['success' => true, 'message' => 'Jadwal diupdate.', 'data' => $j]);
    }
